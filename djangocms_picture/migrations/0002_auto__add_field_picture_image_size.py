...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'djangocms_picture_picture', 'image_size',
                      self.gf('django.db.models.fields.CharField')(default='masonry', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Picture.image_size'
        db.delete_column(u'djangocms_picture_picture', 'image_size')
    ...
    models = {
        ...
        u'djangocms_picture.picture': {
            ...
            'image_size': ('django.db.models.fields.CharField', [], {'default': "'masonry'", 'max_length': '50'}),
